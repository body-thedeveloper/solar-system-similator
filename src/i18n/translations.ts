export const translations = {
  en: {
    ...
    chooseDifficulty: 'Choose your difficulty level to begin the quiz',
    beginner: 'Beginner',
    ...
    tryAgain: 'Try Again!',
    outstanding: 'Outstanding! You really know your solar system!',
    greatWork: 'Great work! You know quite a bit about our solar system!',
    keepLearningMessage: 'Keep learning! You\'ll get better with practice!',
    practiceMakesPerfect: 'Give it another try! Practice makes perfect!',
    level: 'Level',
    retry: 'Try Again',
    finish: 'Finish',
    takeQuiz: 'Take Quiz',
  ...
  ar: {
    ...
    tourGuide: 'جولة المرشد',
    next: 'التالي',
    skip: 'تخطي',
    finishTour: 'انهي الجولة',
    ...
    chooseDifficulty: 'اختر مستوى الصعوبة لبدء الاختبار',
    beginner: 'مبتدئ',
    intermediate: 'متوسط',
    advanced: 'متقدم',
    questions: 'أسئلة',
    ...
    outstanding: 'أداء رائع! أنت تعرف نظامك الشمسي حقاً!',
    greatWork: 'عمل رائع! أنت تعرف الكثير عن نظامنا الشمسي!',
    keepLearningMessage: 'استمر في التعلم! ستحسن مع الوقت!',
    practiceMakesPerfect: 'حاول مرة أخرى! الممارسة تجعل الكمال!',
    level: 'المستوى',
    retry: 'إعادة المحاولة',
    finish: 'انتهى',
    takeQuiz: 'خذ اختبار',
    amazingFact: 'حقيقة مذهلة',
    ...
    // Descriptions
    sunDescription: 'الشمس هي النجم في مركز النظام الشمسي. إنها كرة شبه مثالية من البلازما الساخنة، وهي المصدر الأكثر أهمية للطاقة للحياة على الأرض.',
    mercuryDescription: 'عطارد هو أصغر كواكب النظام الشمسي وأقربها إلى الشمس. يمتلك جسمًا صخريًا مثل الأرض لكنه أصغر بكثير، بقطر يبلغ حوالي 4,880 كم.',
    venusDescription: 'الزهرة هي الكوكب الثاني من الشمس وأقرب جار كوكبي للأرض. إنها واحدة من الكواكب الأرضية الداخلية الأربعة.',
    earthDescription: 'الأرض هي الكوكب الثالث من الشمس والكائن الفلكي الوحيد المعروف بوجود الحياة عليه. إنها العالم الوحيد في نظامنا الشمسي الذي يحتوي على مياه سائلة على سطحه.',
    marsDescription: 'المريخ هو الكوكب الرابع من الشمس وثاني أصغر كواكب النظام الشمسي. يُعرف بلقب "الكوكب الأحمر".',
    jupiterDescription: 'المشتري هو الكوكب الخامس من الشمس وهو بلا منازع أكبر كواكب النظام الشمسي. تساوي كتلته ضعف كتلة جميع الكواكب الأخرى مجتمعة.',
    saturnDescription: 'زحل هو الكوكب السادس من الشمس. يشتهر بنظام حلقاته البارز، وهو الأكثر اتساعًا بين جميع كواكب النظام الشمسي.',
    uranusDescription: 'أورانوس هو الكوكب السابع من الشمس. إنه عملاق جليدي فريد يدور على جانبه، بزاوية ميل محورية تبلغ 98 درجة.',
    neptuneDescription: 'نبتون هو الكوكب الثامن من الشمس وأبعد كواكب نظامنا الشمسي. إنه الكوكب الأكثر عاصفةً، حيث تصل سرعات الرياح إلى 2100 كم/ساعة.',

    // Fun Facts
    sunFunFact: 'الشمس تحتوي على 99.86% من كتلة النظام الشمسي!',
    mercuryFunFact: 'لعطارد تجاعيد! عندما برد لبّه الحديدي وانكمش، تكونت على سطحه "تجاعيد" أو طيات ضاغطة.',
    venusFunFact: 'تدور الزهرة في اتجاه معاكس لمعظم الكواكب، مما يعني أن الشمس تشرق من الغرب وتغرب في الشرق.',
    earthFunFact: 'دوران الأرض يتباطأ تدريجياً. يحدث هذا التباطؤ بشكل غير ملحوظ تقريباً، بمعدل 17 مللي ثانية تقريباً لكل مائة سنة.',
    marsFunFact: 'يضم المريخ أكبر بركان في النظام الشمسي - أولمبس مونس - الذي يبلغ ارتفاعه حوالي 21 كم.',
    jupiterFunFact: 'المشتري ضخم لدرجة أن جميع الكواكب الأخرى يمكن أن تتسع بداخله!',
    saturnFunFact: 'تحتوي حلقات زحل على بلايين الجسيمات الجليدية والصخرية، تتراوح أحجامها من حبة رمل إلى ناطحة سحاب.',
    uranusFunFact: 'يظهر أورانوس ككرة بلا ملامح من السحب الزرقاء المخضرة، مما يجعله أقل الكواكب إثارة للاهتمام من الناحية البصرية.',
    neptuneFunFact: 'رياح نبتون أقوى بثلاث مرات من رياح المشتري، مما يجعله أعاصر الأماكن في النظام الشمسي.'
  }
};
