export const translations = {
  ...
  ar: {
    ...
    // Descriptions
    sunDescription: 'الشمس هي نجم في مركز النظام الشمسي. إنها كرة شبه مثالية من البلازما الساخنة هو بعيد جداً أهم مصدر طاقة للحياة على الأرض.',
    mercuryDescription: 'عطارد هو أصغر كوكب في النظام الشمسي والأقرب إلى الشمس. لديه جسم صخري مثل الأرض لكنه أصغر بكثير.',
    venusDescription: 'الزهرة هو الكوكب الثاني من الشمس هو أقرب جار كوكبي للأرض. إنها واحدة من الكواكب الأرضية الداخلية الأربعة.',
    earthDescription: 'الأرض هو الكوكب الثالث من الشمس والكائن الفلكي الوحيد المعروف الذي يحتوي على حياة. إنها العالم الوحيد في نظامنا الشمسي به مياه سائلة على السطح.',
